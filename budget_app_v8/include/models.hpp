...
struct PaycheckPlan {
    ...
    int startDay = 1;
    int endDay = 15;
    double customVariableBudget = 0.0;
    double customGoalBudget = 0.0;
    double customTaxReserve = 0.0;
    double customExtraDebt = 0.0;
    bool useCustomAllocation = false;
};

struct PaycheckTemplate {
    std::string name;
...
struct Scenario {
    ...
    double extraMonthlyIncome = 0.0;
    double extraMonthlyBills = 0.0;
    double oneTimeShock = 0.0;
    bool active = false;
};

struct ForecastMonth {
    std::string label;
    double projectedIncome = 0.0;
    double projectedOutflow = 0.0;
    double projectedLeftover = 0.0;
    double projectedChecking = 0.0;
    double projectedEmergencyFund = 0.0;
...
struct ScenarioResult {
    ...
    double monthlyLeftover = 0.0;
    double endingChecking = 0.0;
    double endingEmergencyFund = 0.0;
    double endingDebt = 0.0;
    int firstNegativeMonth = -1;
};
